...
var getTargets = exports.getTargets = function getTargets() {
  ...
  if (targetOps.electron) {
    var electronChromeVersion = (0, _normalizeOptions.getElectronChromeVersion)(targetOps.electron);

    targetOps.chrome = targetOps.chrome ? Math.min(targetOps.chrome, electronChromeVersion) : electronChromeVersion;
